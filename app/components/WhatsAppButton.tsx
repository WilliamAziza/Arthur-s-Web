const WHATSAPP_NUMBER = "233000000000"; // Replace with your WhatsApp number (country code + number, no "+" or spaces)
const DEFAULT_MESSAGE = encodeURIComponent(
  "Hello Arthur's Web! I'd like to inquire about your services."
);
